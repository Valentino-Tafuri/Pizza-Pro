      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black text-black">Google My Business</h2>
          ...
          <button
            ...
            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl py-2 px-4 text-sm font-black transition-all active:scale-95"
          >
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                    <p className="text-xs font-semibold text-blue-800">
                      💡 Copia e incolla questa risposta su Google My Business per rispondere alla recensione.
                    </p>
                  </div>
                </div>
              ) : null}
