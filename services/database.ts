...
export const saveData = async (uid: string, sub: string, item: any): Promise<string> => {
  ...
  try {
    ...
    // Only update if id exists and looks like a Firebase document ID (20 chars, alphanumeric)
    // IDs generated by our code (like "ing_1234567890_0") or empty strings should use addDoc instead
    if (id && id.length === 20 && /^[a-zA-Z0-9]{20}$/.test(id)) { 
